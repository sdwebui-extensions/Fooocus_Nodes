...
import time
import math
import fooocus_ldm_patched.modules.model_base
import fooocus_ldm_patched.ldm.modules.diffusionmodules.openaimodel
import comfy.model_management
import fooocus_modules.anisotropic as anisotropic
import fooocus_ldm_patched.ldm.modules.attention
import fooocus_ldm_patched.k_diffusion.sampling
import fooocus_ldm_patched.modules.sd1_clip
import fooocus_modules.inpaint_worker as inpaint_worker
import fooocus_ldm_patched.ldm.modules.diffusionmodules.openaimodel
import fooocus_ldm_patched.ldm.modules.diffusionmodules.model
...
import fooocus_ldm_patched.modules.args_parser
import warnings
import safetensors.torch
import fooocus_modules.constants as constants

from fooocus_ldm_patched.modules.samplers import calc_cond_uncond_batch
from fooocus_ldm_patched.k_diffusion.sampling import BatchedBrownianTree
from fooocus_ldm_patched.ldm.modules.diffusionmodules.openaimodel import forward_timestep_embed, apply_control
from fooocus_modules.patch_precision import patch_all_precision
from fooocus_modules.patch_clip import patch_all_clip
...
def sdxl_encode_adm_patched(self, **kwargs):
    clip_pooled = fooocus_ldm_patched.modules.model_base.sdxl_pooled(kwargs, self.noise_augmentor)
...
def patched_cldm_forward(self, x, hint, timesteps, context, y=None, **kwargs):
    t_emb = fooocus_ldm_patched.ldm.modules.diffusionmodules.openaimodel.timestep_embedding(timesteps, self.model_channels, repeat_only=False).to(x.dtype)
...
def patch_all():
    ...
    # fooocus_ldm_patched.modules.model_patcher.ModelPatcher.calculate_weight = calculate_weight_patched
    ...
    fooocus_ldm_patched.modules.model_base.SDXL.encode_adm = sdxl_encode_adm_patched
    fooocus_ldm_patched.modules.samplers.KSamplerX0Inpaint.forward = patched_KSamplerX0Inpaint_forward
    fooocus_ldm_patched.k_diffusion.sampling.BrownianTreeNoiseSampler = BrownianTreeNoiseSamplerPatched
    fooocus_ldm_patched.modules.samplers.sampling_function = patched_sampling_function
