...
from fooocus_ldm_patched.contrib.external_custom_sampler import SDTurboScheduler
from fooocus_ldm_patched.k_diffusion import sampling as k_diffusion_sampling
from fooocus_ldm_patched.modules.samplers import normal_scheduler, simple_scheduler, ddim_scheduler
from fooocus_ldm_patched.modules.model_base import SDXLRefiner, SDXL
from fooocus_ldm_patched.modules.conds import CONDRegular
from fooocus_ldm_patched.modules.sample import get_additional_models, get_models_from_cond, cleanup_additional_models
from fooocus_ldm_patched.modules.samplers import resolve_areas_and_cond_masks, wrap_model, calculate_start_end_timesteps, \
...
fooocus_ldm_patched.modules.samplers.calculate_sigmas_scheduler = calculate_sigmas_scheduler_hacked
fooocus_ldm_patched.modules.samplers.sample = sample_hacked
