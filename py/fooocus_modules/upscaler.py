...
from fooocus_ldm_patched.pfn.architecture.RRDB import RRDBNet as ESRGAN
from fooocus_ldm_patched.contrib.external_upscale_model import ImageUpscaleWithModel
